    ...
    rocketData.forEach(rocket => {
        ...
        <div class="card-content">
            ...
            <div class="rocket-image">
                <img src="${rocket.image}" alt="Voyager 1">
            </div>
            ...
            <div class="stat-value year line"><p>${rocket.year_built}</p></div>
            ...
            <div class="stat-value speed line"><p>${rocket.max_speed}</p></div>
            ...
            <div class="stat-value cost line"><p>${rocket.development_cost}</p></div>
